                ...
                <div className="row">
                    <div className="col-xl-4 col-lg-6 col-md-6">
                        <div className="latest-news mb-40">
                            <div className="news__thumb mb-25"><img src="https://vue-plum-chi.vercel.app/img/blog/latest/lb4.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipisic eiusmod tempor incididunt ut labore et dolore."/></div>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6">
                        <div className="latest-news mb-40">
                            <div className="news__thumb mb-25"><img src="https://vue-plum-chi.vercel.app/img/blog/latest/lb5.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipisic eiusmod tempor incididunt ut labore et dolore."/></div>
                            <div className="news__caption white-bg">
                                <div className="news-meta mb-15"><span><i className="far fa-calendar-check"></i>  September 15, 2018  </span><span><Link to="#"><i className="far fa-user"></i> MD.</Link></span><span><Link to="#"><i className="far fa-comments"></i> 2 Comments</Link></span></div>
                    ...
                    <div className="col-xl-4 col-lg-6 col-md-6">
                        <div className="latest-news mb-40">
                            <div className="news__thumb mb-25"><img src="https://vue-plum-chi.vercel.app/img/blog/latest/lb6.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipisic eiusmod tempor incididunt ut labore et dolore."/></div>
                            <div className="news__caption white-bg">
                                <div className="news-meta mb-15"><span><i className="far fa-calendar-check"></i>  September 15, 2018  </span><span><Link to="#"><i className="far fa-user"></i> MD.</Link></span><span><Link to="#"><i className="far fa-comments"></i> 2 Comments</Link></span></div>
