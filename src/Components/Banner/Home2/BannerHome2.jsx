                ...
                <div className="row">
                    <div className="col-lg-6 col-md-12">
                        <div className="banner-2 pos-relative mb-30">
                            <Link to="/shop"><img alt="Bannerimage" src="https://vue-plum-chi.vercel.app/img/banner/banner-2/banner1.jpg" /></Link>
                    ...
                    <div className="col-lg-6 col-md-12">
                        <div className="banner-2 pos-relative mb-30">
                            <Link to="/shop"><img alt="Banner" src="https://vue-plum-chi.vercel.app/img/banner/banner-2/banner2.jpg"/></Link>
