...
function UpcomingProduct(props) {
    return (
        <section className="upcoming-product-area pos-relative box-90 pt-120 pb-120" data-background="https://vue-plum-chi.vercel.app/img/bg/bg.jpg" style={{"backgroundImage": "url(https://vue-plum-chi.vercel.app/img/bg/bg.jpg)"}}>
