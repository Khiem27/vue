...
function Footer(props) {
    return (
        <footer>
        <div class="footer-area pl-100 pr-100 mt-100">
            <div class="footer-area box-90 pt-100 pb-60" data-background="/img/bg/footer.jpg" style={{"backgroundImage":"url(https://vue-plum-chi.vercel.app/img/bg/footer.jpg)"}}>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-3 col-lg-5 col-md-6 ">
                            <div class="footer-widget mb-40">
                                ...
                                <div class="footer-time d-flex mt-30">
                                    ...
                                    <div class="time-text"><span>Got Questions ? Call us 24/7!</span>
